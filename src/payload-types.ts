...
export interface Post {
  ...
  /**
   * Number of visitors who have read this post
   */
  visitorsRead?: number | null;
...
export interface ImageWithText {
  /**
   * Choose how to position the text relative to the image
   */
  layout: 'textRight' | 'textLeft' | 'textOverlay';
  image: number | Media;
  /**
   * Add the text content that will appear alongside the image
   */
  text: {
    root: {
      type: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ImageWithText_select".
 */
export interface ImageWithTextSelect<T extends boolean = true> {
  layout?: T;
  image?: T;
  text?: T;
  textColor?: T;
