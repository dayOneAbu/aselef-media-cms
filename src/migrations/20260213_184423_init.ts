...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_image_with_text_layout" AS ENUM('textRight', 'textLeft', 'textOverlay');
  CREATE TYPE "public"."enum_pages_blocks_image_with_text_text_color" AS ENUM('dark', 'light', 'primary');
  CREATE TYPE "public"."enum_pages_blocks_image_with_text_image_size" AS ENUM('small', 'medium', 'large');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_image_with_text_layout" AS ENUM('textRight', 'textLeft', 'textOverlay');
  CREATE TYPE "public"."enum__pages_v_blocks_image_with_text_text_color" AS ENUM('dark', 'light', 'primary');
  CREATE TYPE "public"."enum__pages_v_blocks_image_with_text_image_size" AS ENUM('small', 'medium', 'large');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_image_with_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_pages_blocks_image_with_text_layout" DEFAULT 'textRight',
  	"image_id" integer,
  	"text" jsonb,
  	"text_color" "enum_pages_blocks_image_with_text_text_color",
  	"image_size" "enum_pages_blocks_image_with_text_image_size" DEFAULT 'medium',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_image_with_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__pages_v_blocks_image_with_text_layout" DEFAULT 'textRight',
  	"image_id" integer,
  	"text" jsonb,
  	"text_color" "enum__pages_v_blocks_image_with_text_text_color",
  	"image_size" "enum__pages_v_blocks_image_with_text_image_size" DEFAULT 'medium',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "posts" (
  	...
  	"time_to_read" numeric DEFAULT 3,
  	"visitors_read" numeric DEFAULT 0,
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v" (
  	...
  	"version_time_to_read" numeric DEFAULT 3,
  	"version_visitors_read" numeric DEFAULT 0,
  ...
  CREATE TABLE IF NOT EXISTS "media" (
  	...
  	"sizes_big_square_url" varchar,
  	"sizes_big_square_width" numeric,
  	"sizes_big_square_height" numeric,
  	"sizes_big_square_mime_type" varchar,
  	"sizes_big_square_filesize" numeric,
  	"sizes_big_square_filename" varchar,
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_order_idx" ON "pages_blocks_image_with_text" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_parent_id_idx" ON "pages_blocks_image_with_text" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_path_idx" ON "pages_blocks_image_with_text" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_image_idx" ON "pages_blocks_image_with_text" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_order_idx" ON "_pages_v_blocks_image_with_text" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_parent_id_idx" ON "_pages_v_blocks_image_with_text" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_path_idx" ON "_pages_v_blocks_image_with_text" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_image_idx" ON "_pages_v_blocks_image_with_text" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "media_sizes_big_square_sizes_big_square_filename_idx" ON "media" USING btree ("sizes_big_square_filename");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_image_with_text_layout";
  DROP TYPE "public"."enum_pages_blocks_image_with_text_text_color";
  DROP TYPE "public"."enum_pages_blocks_image_with_text_image_size";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_image_with_text_layout";
  DROP TYPE "public"."enum__pages_v_blocks_image_with_text_text_color";
  DROP TYPE "public"."enum__pages_v_blocks_image_with_text_image_size";
